...
local defaultHeader = {"commonmenu", "ems"}
...
function CMenu:OpenMenu(stringName, boolBack)
	...
	if stringName and not self.Menu[stringName] then print("[CMenu] " .. stringName .. " ne peut pas être ouvert, le menu n'existe pas.") return end
